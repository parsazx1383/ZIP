...
functions = [achareh, smarket, pindo, okorosh, divar, gap, alibaba, digikala, basalam, snapp_doctor, okala, snap, torob, tap30, eavar]
...
def send_requests(phone, count):
    ...
    with ThreadPoolExecutor(max_workers=10) as executor:  # افزایش تعداد کارگرها به 100
        futures = []
        ...
        for i, future in enumerate(futures):
            ...
            sleep(0.1)  # کاهش تاخیر به 0.002 ثانیه برای سرعت 5 برابر
